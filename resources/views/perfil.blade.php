...
@section("content")
    ...
    <section class="container" id="dev-area">
        <div class="car">
            <div class="card-body">
        ...
        const devArea = new Vue({
            ...
            methods:{
                ...
                update(){
                    ...
                    axios.post("{{ url('/profile/update') }}", {name: this.name, address: this.address, phone: this.telephone, identification: this.identification})
                    .then(res => {
